#!/usr/bin/env python3
"""
mod_shop.py — Expanded Mod-Ready Workshop
X: 1285-1305, Z: 1890-1910, Y: 65
Flush-in-floor workspace with wiring sub-floor.
"""
...
print(f"=== Constructing Mod-Ready Workshop at {CX}, {CZ} ===")
...
# 3. Main Floor (Flush design)
safe_fill(X1, YF, Z1, X2, YF, Z2, 'polished_deepslate')

# 4. Flush-in-floor Essentials (Around the center)
# Crafting Table, Furnaces, and Chests at Y=65
setblock(CX, YF, CZ, 'crafting_table')
for ox, oz in [(-1,0), (1,0), (0,-1), (0,1)]:
    setblock(CX+ox, YF, CZ+oz, 'furnace')
for ox, oz in [(-2,-2), (-2,2), (2,-2), (2,2)]:
    setblock(CX+ox, YF, CZ+oz, 'chest')

# 5. Access Hatches to Sub-floor
...
safe_fill(CX-4, YF+2, Z2, CX+4, YF+4, Z2, 'glass_pane')
...
print("=== Mod Workshop Ready for Wiring! ===")
